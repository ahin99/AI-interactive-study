...
export default function KnowledgeMapCompatPage() {
  return (
    <div className="max-w-lg space-y-4 rounded-xl border border-slate-200 bg-white p-8 text-center">
      ...
      <h1 className="text-lg font-semibold text-slate-900">지식 지도 화면이 이동했습니다</h1>
      <p className="text-sm text-slate-500">
        지식 지도와 메타인지 지도는 이제 과목 상세 화면에서 함께 제공됩니다.
      </p>
      <Link
